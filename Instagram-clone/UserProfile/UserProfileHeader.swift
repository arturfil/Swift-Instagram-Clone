...
class UserProfileHeader: UICollectionViewCell {
    ...
    let postsLabel: UILabel = {
        ...
        let attributedText = NSMutableAttributedString(string: "56\n", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 14)])
    ...
    override init(frame: CGRect) {
        ...
        editProfileButton.anchor(top: postsLabel.bottomAnchor, left: postsLabel.leftAnchor, bottom: nil, right: followingLabel.rightAnchor, paddingTop: 4, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 34)
    ...
    fileprivate func setupBottomToolbar() {
        ...
        stackView.anchor(top: topAnchor, left: leftAnchor, bottom: self.bottomAnchor, right: rightAnchor, paddingTop: 140, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 50)
