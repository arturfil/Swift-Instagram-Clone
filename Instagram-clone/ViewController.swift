...
//  Instagram-clone
//
//  Created by Arturo Filio Villa on 10/15/17.
...
let info = convertFromUIImagePickerControllerInfoKeyDictionary(info)
    ...
    fileprivate func setupInputFields() {
        ...
        stackView.anchor(top: plusPhotoButton.bottomAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: 40, paddingLeft: 40, paddingBottom: 0, paddingRight: 40, width: 0, height: 250)
    }
}
